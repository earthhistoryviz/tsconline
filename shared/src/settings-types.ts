...
export type ChartInfoTSC = {
  ...
  export function assertChartSettingsInfoTSC(o: any) : asserts o is ChartSettingsInfoTSC {
    ...
    if (typeof o.variableColors !== "string") throw new Error("ColumnSettingsInfo must have variableColors with type string")
    if (typeof o.noIndentPattern !== "boolean") throw new Error("ColumnSettingsInfo must have noINdentPattern with type boolean")
    ...
    if (typeof o.enEventColBG !== "boolean") throw new Error("ColumnSettingsInfo must have enEventColBG with type boolean")
    if (typeof o.enChartLegend !== "boolean") throw new Error("ColumnSettingsInfo must have enChartLegend with type boolean")
    if (typeof o.enPriority !== "boolean") throw new Error("ColumnSettingsInfo must have enPriority with type boolean")
    if (typeof o.enHideBlockLable !== "boolean") throw new Error("ColumnSettingsInfo must have enHideBlockLable with type boolean")
  ...
  export function assertColumnInfoTSC(o: any) : asserts o is ColumnInfoTSC {
    ...
    if (o.backgroundColor) {
      if ("standardized" in o.backgroundColor) {
        if (typeof o.backgroundColor.standardized !== "boolean") throw new Error("ColumnInfoTSC backgroundColor standardized must have type boolean")
      }
      if ("useNamed" in o.backgroundColor) {
        if (typeof o.backgroundColor.useNamed !== "boolean") throw new Error("ColumnInfoTSC backgroundColor useNamed must have type boolean")
      }
      if (typeof o.backgroundColor.text !== "string") throw new Error("ColumnInfoTSC backgroundColor must have text with type string")
    } else throw new Error("ColumnInfoTSC must have backgroundColor")
    if (o.customColor) {
      if ("standardized" in o.customColor) {
        if (typeof o.customColor.standardized !== "boolean") throw new Error("ColumnInfoTSC customColor standardized must have type boolean")
      }
      if ("useNamed" in o.customColor) {
        if (typeof o.customColor.useNamed !== "boolean") throw new Error("ColumnInfoTSC customColor useNamed must have type boolean")
      }
      if (typeof o.customColor.text !== "string") throw new Error("ColumnInfoTSC customColor must have text with type string")
    } else throw new Error("ColumnInfoTSC must have customColor")
    
    //TODO add fonts info assert here
    
    if ("crunchOuterMargin" in o) {
      if (typeof o.crunchOuterMargin !== "number") throw new Error("ColumnInfoTSC crunchOuterMargin must have type number")
    }
    if ("crunchInnerMargin" in o) {
      if (typeof o.crunchInnerMargin !== "number") throw new Error("ColumnInfoTSC crunchInnerMargin must have type number")
    }
    if ("crunchAscendWidth" in o) {
      if (typeof o.crunchAscendWidth !== "number") throw new Error("ColumnInfoTSC crunchAscendWidth must have type number")
    }
    if ("crunchOneSideSpaceUse" in o) {
      if (typeof o.crunchOneSideSpaceUse !== "number") throw new Error("ColumnInfoTSC crunchOneSideSpaceUse must have type number")
    }
    if ("autoFlip" in o) {
      if (typeof o.autoFlip !== "boolean") throw new Error("ColumnInfoTSC autoFlip must have type boolean")
    }
    if ("orientation" in o) {
      if (o.orientation !== "vertical" || o.orientation !== "normal") throw new Error("ColumnInfoTSC orientation must be vertical or normal")
    }
    if ("type" in o) {
    ...
    if ("justification" in o) {
      if (o.orientation !== "left" || o.orientation !== "right") throw new Error("ColumnInfoTSC orientation must be left or right")
    }
