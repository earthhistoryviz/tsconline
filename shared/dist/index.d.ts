...
export declare function assertDatapackAgeInfo(
  o: any
): asserts o is DatapackAgeInfo;
...
export declare function assertDatapackParsingPack(
  o: any
): asserts o is DatapackParsingPack;
export declare function assertDatapackIndex(o: any): asserts o is DatapackIndex;
export declare function assertFaciesLocations(
  o: any
): asserts o is FaciesLocations;
export declare function assertFaciesTimeBlock(
  o: any
): asserts o is FaciesTimeBlock;
export declare function assertIndexResponse(o: any): asserts o is IndexResponse;
export declare function assertDatapackResponse(
  o: any
): asserts o is DatapackResponse;
export declare function assertChartConfig(o: any): asserts o is ChartConfig;
export declare function assertChartConfigArray(
  o: any
): asserts o is ChartConfig[];
...
export declare function assertParentMap(
  parent: any
): asserts parent is ParentMap;
...
export declare function assertBounds(
  coordtype: string,
  bounds: any
): asserts bounds is Bounds;
export declare function assertVertBounds(
  vertBounds: any
): asserts vertBounds is VertBounds;
export declare function assertRectBounds(
  rectBounds: any
...
export declare function assertSuccessfulServerResponse(
  o: any
