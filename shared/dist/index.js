...
export function assertDatapackAgeInfo(o) {
  ...
  if (typeof o.useDatapackSuggestedAge !== "boolean")
    throw new Error(
      "DatapackAgeInfo must have a boolean useDatapackSuggestedAge"
    );
...
export function assertDatapackParsingPack(o) {
  ...
  if (!Array.isArray(o.columnInfoArray))
    throw new Error(
      `DatapackParsingPack must have a columnInfoArray array of ColumnInfos`
    );
...
export function assertColumnInfo(o) {
  ...
  for (const child of o.children) {
    if (child === null || typeof child !== "object") {
      throw new Error(
        `'ColumnInfo' must have a children array with all values non-null: ${child}`
      );
    }
