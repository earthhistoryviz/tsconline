...
export const TSCDatapackCard: React.FC<TSCDatapackCardProps> = ({ name, datapack, value, onChange }) => {
  ...
  return (
    <Card className={styles.card} sx={{ outline: "1px solid", outlineColor: "divider", bgcolor: "secondaryBackground.main"}} onClick={() => navigate(`/datapack/${encodeURIComponent(name)}`)}>
