      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        <AccordionDetails>
          <div>
            ...
            { Object.entries(state.settingsTabs.columns).map(([ columnname, columninfo]) => {
              return <div>
                <label>
                  <Checkbox checked={columninfo.on} onChange={() => actions.toggleSettingsTabColumn(columnname, []) }/>{columnname}
                </label>
              </div>
            })}
