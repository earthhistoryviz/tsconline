export const qsg = [
  ...
  },
  {
    target: ".qsg-chart",
    content:
      "In the Chart page, you can view the charts you have created and explore the detailed visualizations of geologic events. Additionally, you have the option to download and save these charts for your reference or further analysis.",
    showSkipButton: true,
    hideCloseButton: true
  },
  {
  ...
  },
  {
    ...
    content:
      "In the Workshops Page, you can access a range of educational and experimental tutorials that offer in-depth guidance. Here, you can explore the workshops you have registered for, allowing you to engage with the content and enhance your skills in a hands-on learning environment.", // Holding off on the Workshops tour until we finish up the backend. Want to make sure it matches any changes we end up making to the page.
    showSkipButton: true,
    hideCloseButton: true
  },
  {
  ...
  },
  {
    target: ".login-tab",
    content:
      "Click here to sign in and unlock the features mentioned earlier, such as accessing registered workshops. Once logged in, you will also have the ability to upload datapacks and take full advantage of all functionalities.",
    showSkipButton: true,
    hideCloseButton: true
  }
];
...
export const settingsTour = [
  {
    ...
    content:
      'In the Time settings, you can Set the "Top of Interval" and "Base of Interval" for your data. These fields allow you to define the starting and ending ages or stages, which can be adjusted by entering values or using the dropdown selectors. Adjust the vertical scale to change how much vertical space each million years occupies on your charts. For example, setting it higher will spread the intervals further apart, making each period easier to examine closely. You also can customize the display settings. For instance, you can choose to gray out columns with no data for selected time intervals, add tooltips with additional information, or enable filtering and legend options for the chart. ',
    showSkipButton: true,
    hideCloseButton: true,
    disableBeacon: true
  },
  ...
  },
  {
    ...
    content:
      "In the Map Points Settings, you can access and manage geographic data points for different locations. This feature allows you to view specific location details directly on the interactive map. You can toggle different map layers and visualize data points with detailed descriptions, like latitude, longitude, and additional notes. Please note, however, that not all datapacks contain map points.",
    showSkipButton: true,
    hideCloseButton: true,
    disableBeacon: true
  },
