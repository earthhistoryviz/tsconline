    ...
    return (
        <Box padding={4} borderRadius={2}>
            ...
            <Grid container alignItems="center" justifyContent="space-between">
                ...
                <Typography variant="h5" fontWeight={"bold"}>{workshop.title}</Typography>
                <Box>
                    <img
                        src={TSCreatorLogo}
            ...
            >
                <Grid container spacing={4}>
                    <Grid item xs={3}>
                        ...
                        <Typography variant="h6" fontWeight={"bold"}>End Date</Typography>
                        <Typography>{workshop.end}</Typography>

                        <Divider sx={{ marginY: 1 }} />

                        {/* Data Packs */}
                        <Typography variant="h6" fontWeight={"bold"}>Data Packs</Typography>
                        <Box >
