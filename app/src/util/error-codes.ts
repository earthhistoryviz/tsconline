...
export const ErrorMessages = {
  ...
  [ErrorCodes.UNABLE_TO_LOGIN_EXISTING_USER]:
    i18n.t("errors.UNABLE_TO_LOGIN_EXISTING_USER"),
  ...
  [ErrorCodes.UNABLE_TO_SIGNUP_USERNAME_OR_EMAIL]:
    i18n.t("errors.UNABLE_TO_SIGNUP_USERNAME_OR_EMAIL"),
  [ErrorCodes.INVALID_FORM]: i18n.t("errors.INVALID_FORM"),
  [ErrorCodes.UNABLE_TO_VERIFY_ACCOUNT]:
    i18n.t("errors.UNABLE_TO_VERIFY_ACCOUNT"),
  ...
  [ErrorCodes.TOKEN_EXPIRED_OR_INVALID]:
    i18n.t("errors.TOKEN_EXPIRED_OR_INVALID"),
  ...
  [ErrorCodes.UNABLE_TO_LOGIN_ACCOUNT_LOCKED]:
    i18n.t("errors.UNABLE_TO_LOGIN_ACCOUNT_LOCKED"),
  ...
  [ErrorCodes.USER_DATAPACK_FILE_NOT_FOUND_FOR_DOWNLOAD]:
    i18n.t("errors.USER_DATAPACK_FILE_NOT_FOUND_FOR_DOWNLOAD"),
