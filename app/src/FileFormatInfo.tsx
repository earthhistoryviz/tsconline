...
<ul>
 ...
 <table border="0">
 <tr>
	 <td><img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/patternWidthExample.png" alt="pattern width example" width="155" height="326" /><br />Example of pattern widths</td>
    <td valign="top">
...
<td>
<img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_ex1.png" alt="Transect ex1" width="246" height="585" />
</td>
</tr>
</table>
...
<p>The template can be generated using the &quot;Save Transect Template...&quot; option in the File menu of the Image Editor. A window like this appears:<br />
  <img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_save_template.png" width="543" height="331" /><br />
...
<img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_template.png" width="325" height="313" border="1"/><br />
...
<img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_template_with_error.png" width="334" height="297" border="1"/><br />
...
<p>Once the template is done, save it and load it into TSC using &quot;Load Transect Column from Template...&quot; from the File menu of the Image Editor. A window like this appears:<img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_load_template_with_error.png" width="750" height="750" /></p>
<p>There are three main options to help with loading: point merge distance, and snap to grid for age and X. Point merge distance helps to make sure that points which are shared between two polygons are found correctly.<br />
  ...
  <img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_template_space.png" width="459" height="117" border="1" /><br />
...
<img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_template_space_merged.png" width="240" height="147" border="1" /></p>
...
<p>If you look closely, you will notice that there are some lines in the preview highlighted red. That means that there are intersections in the template, which is not allowed. One can play with the  point merge distance and grid and see if that takes care of the problem, but in this case it won't. Zooming in closely on the region of the template we notice that one polygon doesn't have a point where the neighboring polygons do:<br />
  <img src="$FILE_FORMAT_GUIDE_IMAGES_BASEDIR/transect_template_missing_point.png" width="538" height="285" /><br />
