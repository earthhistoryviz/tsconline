...
export const setInheritable = action((target: "Column Header" | "Age Label" | "Uncertainty Label" | "Zone Column Label" | "Event Column Label" | "Range Label", isInheritable
    : boolean) => {
...
export const setFontSize = action((target: "Column Header" | "Age Label" | "Uncertainty Label" | "Zone Column Label" | "Event Column Label" | "Range Label", fontSize: number) => {
    if (state.settingsTabs.columnSelected === null) {
        throw new Error("state.settingsTabs.columnSelected is null");
    }
...
export const setBold = action((target: "Column Header" | "Age Label" | "Uncertainty Label" | "Zone Column Label" | "Event Column Label" | "Range Label", isBold: boolean) => {
    if (state.settingsTabs.columnSelected === null) {
        throw new Error("state.settingsTabs.columnSelected is null");
    }
...
export const setItalic = action((target: "Column Header" | "Age Label" | "Uncertainty Label" | "Zone Column Label" | "Event Column Label" | "Range Label", isItalic: boolean) => {
    if (state.settingsTabs.columnSelected === null) {
        throw new Error("state.settingsTabs.columnSelected is null");
    }
...
export const setColor = action((target: "Column Header" | "Age Label" | "Uncertainty Label" | "Zone Column Label" | "Event Column Label" | "Range Label", color: React.SetStateAction<string>) => {
    if (state.settingsTabs.columnSelected === null) {
        throw new Error("state.settingsTabs.columnSelected is null");
    }
