...
import { buildSettingsSchema, applySchemaToColumnInfo, applySchemaToChartSettings, SettingsSchema } from "./build-settings-schema.js";
 ...
 */
export async function generateChartWithSchema(
  datapacks: Datapack[],
