...
//download datapack
server.post<{ Params: { needEncryption: string, filePath: string, datapackDir: string } }>("/requestDownload/:needEncryption/:filePath/:datapackDir", routes.requestDownload);
