import { BaseDatapackProps, DatapackIndex, MapPack, MapPackIndex, assertDatapackIndex, assertMapPackIndex } from "@tsconline/shared";
import { Mutex } from "async-mutex";
import { readFile, writeFile } from "fs/promises";
import { checkFileExists } from "./util";

const mutex = new Mutex();
export async function addPublicUserDatapack(filename: string, datapack: BaseDatapackProps, datapackIndexFilepath: string, mapPackIndexFilepath: string, mapPack?: MapPack) {
